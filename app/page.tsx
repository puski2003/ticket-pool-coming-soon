...
export default function Home() {
  return (
    <div className="h-screen ">
      ...
      <Image alt="pestal shape" src={pestalShape} className=" w-[120px] sm:w-[150px]  md:w-[200px] absolute  bottom-20 left-8 md:bottom-20 md:left-16" />
      <Image alt="gradient shape" src={gradientShape} className=" w-[110px] sm:w-[150px] w-[200px] absolute top-24 right-4 md:top-20 lg:right-16" />
      <div>
